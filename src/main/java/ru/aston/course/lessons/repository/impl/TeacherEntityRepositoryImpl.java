...
import ru.aston.course.lessons.repository.mapper.TeacherResultSetMapperImpl;
...
public class TeacherEntityRepositoryImpl implements TeacherEntityRepository {
    private static final TeacherEntityRepositoryImpl INSTANCE = new TeacherEntityRepositoryImpl();
    ...
    private TeacherResultSetMapper resultSetMapper = new TeacherResultSetMapperImpl();
    private final ConnectionManager connectionManager = ConnectionManagerImpl.getInstance();

    private TeacherEntityRepositoryImpl() {
    ...
    public static TeacherEntityRepositoryImpl getInstance() {
        return INSTANCE;
    }
}
